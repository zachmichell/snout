...
import ReportCardTemplates from "./pages/portal/pet-care/ReportCardTemplates";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/report-card-templates" element={staff(<ReportCardTemplates />, "reportcards.publish")} />
